...
public class MovimentacaoController implements Initializable  {
    ...
    @FXML
    private DatePicker datePickerMes;
    @FXML
    ...
    @FXML
    private TableColumn<Movimentacao, String> tableColumnHora;
    @FXML
    private TableColumn<Movimentacao, String> tableColumnValor;
    @FXML
    private TableColumn<Movimentacao, String> tableColumnTipo;
    @FXML
    private TableColumn<Movimentacao, String> tableColumnCategoria;
    @FXML
    private TableColumn<Movimentacao, String> tableColumnDescricao;
    ...
    private void adicionar(ActionEvent event) throws IOException {
        ...
        MovimentacaoController controller = (MovimentacaoController) loader.getController();
    ...
    @FXML
    private void accionAvancarMes(ActionEvent event) {
        LocalDate mes = datePickerMes.getValue();
        datePickerMes.setValue(mes.plusMonths(1));
        isPorMes = true;
        //listarPorMes();
    }
    ...
    @FXML
    private void irBtReceita(ActionEvent event) {
        if(btReceita.isSelected()){
            listarQualTipo = true;
        } else {
            listarQualTipo = null;
        }
    ...
    @FXML
    private void btFechar(ActionEvent event) {
        System.exit(1);
    }
...
////////////////////////////////////////////////////////////////////////////////
    // Controller do Formulario Movimentacao
    @FXML
